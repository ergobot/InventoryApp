...
import com.example.android.inventoryapp.ProductDbHelper;
...
public class ProductContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.android.inventoryapp.contentprovider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriType) {
            ...
            case PRODUCT_ID:
                ...
                queryBuilder.appendWhere(ProductEntry.COLUMN_ID + "="
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case PRODUCTS:
                rowsDeleted = sqlDB.delete(ProductEntry.TABLE_NAME, selection,
                        selectionArgs);
                break;
            case PRODUCT_ID:
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            case PRODUCTS:
                rowsUpdated = sqlDB.update(ProductEntry.TABLE_NAME,
                        values,
                        selection,
                        selectionArgs);
                break;
    ...
    private void checkColumns(String[] projection) {
        String[] available = {ProductEntry.COLUMN_NAME,
